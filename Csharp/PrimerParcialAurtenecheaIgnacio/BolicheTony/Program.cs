...
namespace BolicheTony
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine();
            Comercio.MostrarArticulos(ElBolicheDeToni); // modifique la llamada al metodo estaba mal escrita.
            Console.WriteLine();
            Comercio.MostrarGanancia(ElBolicheDeToni); // modifique la llamada al metodo estaba mal escrita.
            Console.ReadLine();
        }
    }
}
