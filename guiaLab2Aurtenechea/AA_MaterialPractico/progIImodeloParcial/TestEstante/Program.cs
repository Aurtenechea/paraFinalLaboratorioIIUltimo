...
using progIImodeloParcial; //incluye todo lo de este namespace dentro del namespace TestPrimerParcial o algo asi.
...
namespace TestPrimerParcial
{
    class Program
    {
        ...
        {
            Console.WriteLine( "INDICE!!: " + String.Compare(((int)p).ToString(), ((int)p1).ToString()).ToString());
            return String.Compare(((int)p).ToString(), ((int)p1).ToString()); // devuelve positivo si el primero es mayor que el segundo.
